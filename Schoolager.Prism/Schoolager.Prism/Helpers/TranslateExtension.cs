...
namespace Schoolager.Prism.Helpers
{
    ...
    public class TranslateExtension: IMarkupExtension
    {
        ...
        private const string ResourceId = "Schoolager.Prism.Resources.Resource";
        private static readonly Lazy<ResourceManager> ResMgr = new Lazy<ResourceManager>(()=> new ResourceManager(
            ResourceId,
